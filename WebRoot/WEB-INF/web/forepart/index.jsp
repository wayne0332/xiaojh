...
<body>
	<div class="container cf">
		...
		<div class="cityMap w mt75 mb50 fl">
			...
			<button
				class="index_Abt circle_100 hov shadow_l_5 fl <s:if test="#session.user != null || #session.merchant != null">none</s:if>"
				id="mapToAdv">切换到活动</button>
			<ul
				class="cityMapUl w700 h400 fl cf <s:if test="#session.user != null|| #session.merchant != null">none</s:if>"
				id="mapPanel">
			...
			<div
				class="mapBar w300 fl <s:if test="#session.user != null || #session.merchant != null">none</s:if>"
				id="mapBar">
				...
				<ul class="campusList w250 mt15 ml30 pb50 cf shadow_l_5 ulNankai">
					<li class="campusList_li1 h30 pl10 pr10">天津市 - 南开区 和平区</li>
					<li><a href="school?school.id=2" class="w230 h30 pl10 pr10">天津大学</a>
					</li>
					<li><a href="school?school.id=1" class="w230 h30 pl10 pr10">南开大学</a>
					</li>
					<li><a href="school?school.id=10" class="w230 h30 pl10 pr10">天津中医药大学</a>
					</li>
					<li><a href="school?school.id=11" class="w230 h30 pl10 pr10">天津外国语大学</a>
					</li>
					<li><a href="school?school.id=12" class="w230 h30 pl10 pr10">天津财经大学（和平）</a>
					</li>
					<li><a href="school?school.id=13" class="w230 h30 pl10 pr10">天津医科大学</a>
					</li>
				</ul>
				<ul
					class="campusList w250 mt15 ml30 pb50 cf shadow_l_5 ulXiqing none">
					<li class="campusList_li1 h30 pl10 pr10">天津市 - 西青区 静海区</li>
					<li><a href="school?school.id=3" class="w230 h30 pl10 pr10">天津工业大学</a>
					</li>
					<li><a href="school?school.id=5" class="w230 h30 pl10 pr10">天津师范大学</a>
					</li>
					<li><a href="school?school.id=4" class="w230 h30 pl10 pr10">天津理工大学</a>
					</li>
					<li><a href="school?school.id=6" class="w230 h30 pl10 pr10">天津城建学院</a>
					</li>
					<li><a href="school?school.id=7" class="w230 h30 pl10 pr10">天津农学院</a>
					</li>
					<li><a href="school?school.id=8" class="w230 h30 pl10 pr10">天津宝德商学院</a>
					</li>
					<li><a href="school?school.id=14" class="w230 h30 pl10 pr10">天津仁爱学院</a>
					</li>
				</ul>
				<ul class="campusList w250 mt15 ml30 pb50 cf shadow_l_5 ulHexi none">
					<li class="campusList_li1 h30 pl10 pr10">天津市 - 河西区 大港区</li>
					<li><a href="school?school.id=15" class="w230 h30 pl10 pr10">天津科技大学</a>
					</li>
					<li><a href="school?school.id=16" class="w230 h30 pl10 pr10">天津体育学院</a>
					</li>
					<li><a href="school?school.id=17" class="w230 h30 pl10 pr10">天津职业技术师范大学</a>
					</li>
					<li><a href="school?school.id=18" class="w230 h30 pl10 pr10">天津医科大学临床医学院</a>
					</li>
					<li><a href="school?school.id=19" class="w230 h30 pl10 pr10">天津财经大学（河西）</a>
					</li>
				</ul>
				<ul
					class="campusList w250 mt15 ml30 pb50 cf shadow_l_5 ulHebei none">
					<li class="campusList_li1 h30 pl10 pr10">天津市 - 河北区 河东区</li>
					<li><a href="school?school.id=20" class="w230 h30 pl10 pr10">天津美术学院</a>
					</li>
					<li><a href="school?school.id=21" class="w230 h30 pl10 pr10">天津音乐学院</a>
					</li>
				</ul>
				<ul
					class="campusList w250 mt15 ml30 pb50 cf shadow_l_5 ulBeicheng none">
					<li class="campusList_li1 h30 pl10 pr10">天津市 - 北辰区 红桥区</li>
					<li><a href="school?school.id=22" class="w230 h30 pl10 pr10">天津商业学院</a>
					</li>
					<li><a href="school?school.id=23" class="w230 h30 pl10 pr10">河北工业大学</a>
					</li>
				</ul>
				<ul
					class="campusList w250 mt15 ml30 pb50 cf shadow_l_5 ulWuqing none">
					<li class="campusList_li1 h30 pl10 pr10">天津市 - 武清区</li>
					<li><a href="school?school.id=9" class="w230 h30 pl10 pr10">天津天狮大学</a>
					</li>
				</ul>
				<ul
					class="campusList w250 mt15 ml30 pb50 cf shadow_l_5 ulDongli none">
					<li class="campusList_li1 h30 pl10 pr10">天津市 - 东丽区 塘沽区</li>
					<li><a href="school?school.id=24" class="w230 h30 pl10 pr10">中国民航大学</a>
					</li>
					<li><a href="school?school.id=25" class="w230 h30 pl10 pr10">南大滨海</a>
					</li>
				</ul>
			</div>
