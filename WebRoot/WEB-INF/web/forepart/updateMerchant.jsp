...
<body>
	...
	<ul>
		...
		<li><span>商家名:</span>
		<s:property value="#session.merchant.merchantName" /></li>
		<li><span>类型:</span> <s:select name="merchant.type"
				list="@com.tjxjh.enumeration.MerchantType@values()" listKey="name()"
				listValue="name" value="#session.merchant.club.type" />
		</li>
		<li><span>行业:</span> <s:select name="merchant.business"
				list="@com.tjxjh.enumeration.MerchantBusiness@values()"
				value="#session.merchant.business" listKey="name()" listValue="name" />
		</li>
		<li><span>合作意向:</span> <s:checkboxlist name="purpose"
				list="@com.tjxjh.util.MerchantPurposeUtil@purposesMap" /> <s:iterator
				value="@com.tjxjh.util.MerchantPurposeUtil@purposesMap">
					<s:if test="@com.tjxjh.util.MerchantPurposeUtil@isContainsPurpose(#session.merchant.purpose,key)">
						YEAH
					</s:if>
