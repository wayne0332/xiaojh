	...
	<form action="updateMerchant" method="post"
		...
		<ul>
			...
			<li><span>Logo:</span> <img
				src="${sessionScope.merchant.logoPath }">
			</li>
			<li><span>新Logo:</span> <input type="file" name="logo"
				class="input_file" />
			</li>
			<li><span>&nbsp;</span></li>
			<li><span>&nbsp;</span> <input type="hidden" name="merchant.id"
				value="${sessionScope.merchant.id }" /><input type="submit"
				value="更新" class="input_submit hov" />
			</li>
		</ul>
	</form>
</body>
