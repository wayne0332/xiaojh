  ...
  <body>
    <div class="div">
	 	...
	 	<form action="addActivity" method="post" enctype="multipart/form-data">
	 		活动标题:<input type="text" name="activity.tittle"/><br>
	     	新闻内容：<textarea id="editor" name="activity.text" id="ncontent" style="width:100%;height:400px;"></textarea><br>
	     	活动封面图片链接:<input type="text" name="activity.titleImgPath"/><br>
	     	活动视频连接:<input type="text" name="activity.videoUrl"/><br>
	     	活动预算资金：<input type="text" name="activity.budget"/>元<br>
	     	活动组织：<input type="text" name="activity.organizer"/><br>
	     	活动举办地点：<input type="text" name="activity.place"/><br>
