		...
		<table>
			<tr>
				...
				<td><input type="text" name="merchant.name"><label
					id="nameMsg" style="display:none;color:red;"></label>
				</td>
			</tr>
			<tr>
				<td>商家名:</td>
				<td><input type="text" name="merchant.merchantName">
				</td>
			</tr>
			<tr>
				<td>密码:</td>
				<td><input type="password" name="merchant.password">
				</td>
			</tr>
			<tr>
				<td>类型:</td>
			...
			<tr>
				...
				<td><s:checkboxlist name="purpose"
						list="@com.tjxjh.util.MerchantPurposeUtil@purposesMap" /></td>
			</tr>
			<tr>
				<td>地址:</td>
			...
			<tr>
				<td>联系人姓名:</td>
				<td><input type="text" name="merchant.connectorName">
				</td>
			</tr>
			<tr>
				<td>联系人电话:</td>
			...
			<tr>
				<td>联系人QQ:</td>
				<td><input type="text" name="merchant.connectorQq">
				</td>
			</tr>
			<tr>
				<td>联系人邮箱:</td>
				<td><input type="text" name="merchant.connectorEmail">
				</td>
			</tr>
			<tr>
				<td>Logo:</td>
