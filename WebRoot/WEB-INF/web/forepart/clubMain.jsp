...
.main {}
.top{}
.rectRow{background-color:#dde; }
.rectBlock{float: left;width: 340px;  }
.rectBlock a{text-decoration: none;}
.header {}
.left {float: left;width: 680px;}
.right {float: right;margin: 0 0;padding: 0 0;width: 220px;}
.rightBlock{float:left;}
.portrait {width: 44px;float: left;margin-top: 20px;}
.portraitImg {padding-top: 5px;}
</style>
...
<body>
	<div class="container">
		...
		<div class="main">
			<div class="top" >
				<s:if test="#session.clubMember != null">
					<s:if test="#session.clubMember.status.name() == 'NO_CHECK'">
					等待确认
					</s:if>
					<s:else>
					...
					<s:a href="clubMembers">社团成员<s:if
						...
						<a href="clubAnnouncements">社团通告</a>
					</s:a>
					</s:else>
				</s:if>
			<s:else>
			...
			<div class="right">
				<div class="rightBlock">
					<div>
						关注社团&nbsp;&nbsp;&nbsp;&nbsp;<a href="clubFocus?type=1">更多</a><s:property value="" />
					</div>
					<div>
